<template>
  <section class="side-nav">
    <section class="logo-icon-pattern">
      <router-link to="/">
        <div class="monday-icon" v-tippy="{ content:'Home Page', theme : 'classicRight', placement: 'right', arrow: true }">
          <img
...
<script>
import { bottom, placements } from '@popperjs/core';
